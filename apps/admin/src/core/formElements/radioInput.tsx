  ...
  return (
    ...
    >
      <input
        ...
        type="radio"
        required={required}
        className="appearance-none relative w-[14px] h-[14px] rounded-full border border-gray-200 bg-blue-500 inline-flex cursor-pointer focus-visible:outline-none focus-visible:ring focus-visible:ring-blue-400 focus-visible:ring-offset-2 focus-visible:ring-offset-inheritBg before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:h-[12px] before:w-[12px] before:rounded-full before:scale-100 before:bg-white before:transition-transform before:duration-100 before:ease-in-out checked:border-blue-500 checked:before:scale-[.33]"
      />
