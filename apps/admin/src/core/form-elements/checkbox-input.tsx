    ...
    >
      <span className="relative flex">
        <input
          ...
          type="checkbox"
          required={required}
          className="relative inline-flex h-[14px] w-[14px] cursor-pointer appearance-none rounded-0.5 border border-gray-200 bg-white transition-colors duration-100 ease-in-out checked:border-blue-500 checked:bg-blue-500 focus-visible:focus-spaced-blue-400"
        />
