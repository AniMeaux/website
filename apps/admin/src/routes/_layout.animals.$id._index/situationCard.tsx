...
const DIAGNOSIS_ICON: Record<
  ...
  React.ReactNode
> = {
  [Diagnosis.CATEGORIZED]: <Icon id="shieldDog" className="text-red-500" />,
  [Diagnosis.UNCATEGORIZED]: <Icon id="shieldDog" className="text-green-600" />,
  [Diagnosis.UNKNOWN]: <Icon id="shieldDog" />,
};
