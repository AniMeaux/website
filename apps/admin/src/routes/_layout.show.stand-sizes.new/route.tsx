...
import { ErrorPage } from "#core/data-display/error-page.js";
import { PageLayout } from "#core/layout/page.js";
import { getPageTitle } from "#core/page-title.js";
import { FieldsetDetails } from "#show/stand-size/fieldset-details.js";
import { FieldsetIdentification } from "#show/stand-size/fieldset-identification.js";
import { FieldsetPrices } from "#show/stand-size/fieldset-prices.js";
import { FieldsetSituation } from "#show/stand-size/fieldset-situation.js";
