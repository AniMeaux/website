...
export function inputClassName({
  ...
  return cn(
    "appearance-none w-full min-w-0 rounded-0.5 ring-inset ring-1 py-1 placeholder:text-gray-500 focus:outline-none focus-visible:ring-outset focus-visible:ring",
    {
