...
const SHAPE_SRC_DIRECTORY = resolve(DIRNAME, "../imageShapes");
const DEST_DIRECTORY = resolve(DIRNAME, "../src/generated");
const SPRITE_DEST_FILE = join(DEST_DIRECTORY, "imageShapesSprite.svg");
const TYPES_DEST_FILE = join(DEST_DIRECTORY, "imageShapeId.ts");
