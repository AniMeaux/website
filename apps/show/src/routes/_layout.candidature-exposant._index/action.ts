...
import { SMALL_SIZED_STANDS_ACTIVITY_FIELDS } from "./activity-field";
import { OTHER_SHOW_LEGAL_STATUS } from "./legal-status";
import { isLargeStandSize } from "./stand-size";
  ...
  .object({
    contact: zu.object({
      ...
      email: zu
        ...
        .max(64, "Veuillez entrer une adresse email plus courte"),
      phone: zu
