...
export namespace StandSize {
  ...
  export const translation: Record<ShowStandSize, string> = {
    [Enum.S_6]: "6 m² (3x2)",
    [Enum.S_9]: "9 m² (3x3)",
    [Enum.S_12]: "12 m² (4x3)",
    [Enum.S_18]: "18 m² (6x3)",
  ...
  export const valuesSmallSize = values.filter(
    (standSize) => !isLargeStandSize(standSize),
  );

  function isLargeStandSize(standSize: Enum) {
    return area[standSize] >= area[Enum.S_12];
  }
}
