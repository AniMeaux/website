...
export const MAX_DIVIDER_COUNT_BY_STAND_SIZE: Record<StandSize.Enum, number> = {
...
export const MAX_DIVIDER_COUNT = Math.max(
  ...Object.values(MAX_DIVIDER_COUNT_BY_STAND_SIZE),
);
