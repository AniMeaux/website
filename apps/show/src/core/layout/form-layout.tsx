...
export const FormLayout = {
  ...
  >(function FormLayoutRoot({ className, ...props }, ref) {
    return (
      <Primitive.section
        ...
        ref={ref}
        className={cn(
          "grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_248px] md:items-start md:gap-4 lg:gap-8",
          className,
        )}
      />
    );
  ...
  >(function FormLayoutNav({ className, ...props }, ref) {
    return (
      <Primitive.aside
        ...
        ref={ref}
        className={cn(
          "sticky top-4 hidden grid-cols-1 rounded-2 bg-alabaster px-2 py-1 md:grid",
          className,
        )}
      />
    );
  ...
  Separator: function FormLayoutSeparator() {
  ...
  >(function FormLayoutInput({ className, ...props }, ref) {
    return (
      <Primitive.input
        ...
        ref={ref}
        className={cn(
          "rounded-0.5 border border-mystic-200 bg-transparent px-1 py-0.5 placeholder:text-prussianBlue/50 can-hover:focus-visible:focus-compact",
          className,
        )}
      />
    );
  ...
  >(function Textarea({ className, ...props }, ref) {
    return (
      <textarea
        ...
        ref={ref}
        className={cn(
          "rounded-0.5 border border-mystic-200 px-1 py-0.5 can-hover:focus-visible:focus-compact",
          className,
        )}
      />
    );
  ...
  >(function FormLayoutSelectors(
    ...
    return (
      <Primitive.div
        ...
        style={{
          ...style,
          gridTemplateColumns: `repeat(auto-fill, minmax(${columnMinWidth}, 1fr))`,
        }}
      />
    );
  }),
