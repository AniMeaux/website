...
const COMMON_CLASS_NAME =
  "focus:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:ring-blue-500 shadow-md bg-blue-500 active:bg-blue-700 text-white z-20 fixed quick-action-bottom quick-action-right rounded-full h-14 w-14 flex items-center justify-center text-2xl";
